...
#pragma config(Motor,  port1,           frontRight,    tmotorVex393_HBridge, openLoop, reversed, encoderPort, dgtl1)
...
#pragma config(Motor,  port9,           tail,          tmotorVex393_MC29, openLoop)
