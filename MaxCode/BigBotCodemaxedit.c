...
#pragma config(Motor,  port6,           leftExpand,    tmotorVex269, openLoop)
#pragma config(Motor,  port7,           rightExpand,   tmotorVex269, openLoop)
#pragma config(Motor,  port9,           topArm,        tmotorVex393, openLoop, reversed)
#pragma config(Motor,  port10,          backLeft,      tmotorVex393, openLoop, reversed, encoder, encoderPort, dgtl11, 1000)
